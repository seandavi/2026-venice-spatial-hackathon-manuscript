...
repositories linked from the relevant team sections.

# Author contributions

H.C., L.M., W.H., and D.R. organized and led the hackathon. All authors
participated in one or more team projects and contributed to the manuscript.
...
@tbl-image-stack and the diagrams in @fig-spatialdata-layers and
@fig-stratified-de-pipeline. The authors reviewed all AI output and
retain full responsibility for the manuscript's content.
